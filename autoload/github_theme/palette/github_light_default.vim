" autoload/github_theme/palette/github_light_default.vim
" AUTO-GENERATED from projekt0n/github-nvim-theme. Do not edit.
"
" Public API:
"   github_theme#palette#github_light_default#meta() -> {name, light}
"   github_theme#palette#github_light_default#get()  -> palette dict
"   github_theme#palette#github_light_default#spec() -> spec dict (includes .palette)

function! github_theme#palette#github_light_default#meta() abort
  return {
...
function! github_theme#palette#github_light_default#get() abort
  return {
    \ 'orange': '#fb8f44',
    \ 'gray': '#6e7781',
    \ 'black': {
...
function! github_theme#palette#github_light_default#spec() abort
  let l:spec = {
    \ 'bg0': '#f6f8fa',
    \ 'bg1': '#ffffff',
    \ 'bg2': '#f0f1f2',
    ...
    \ }
  \ }
  let l:spec.palette = github_theme#palette#github_light_default#get()
